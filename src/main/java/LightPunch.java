...
public class LightPunch extends LightAbility implements AddonAbility {
    ...
    public LightPunch(Player player) {
        ...
        this.description = ConfigManager.getConfig().getString("ExtraAbilities.Amfich.Spirit.LightSpirit.LightPunch.Description");
        start();
    }
    ...
    public void load() {
        ...
        ConfigManager.getConfig().addDefault("ExtraAbilities.Amfich.Spirit.LightSpirit.LightPunch.Description", "With this ability you can shoot light energy at players or mobs!");
