...
public class StarBlast extends LightAbility implements AddonAbility {
    ...
    public void load() {
        ...
        ConfigManager.getConfig().addDefault("ExtraAbilities.Amfich.Spirit.LightSpirit.LightPunch.Description", "Using the energy of light, you can summon stars to your enemies!");
